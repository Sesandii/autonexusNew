register page controller with gender as dropdown
...
$gender     = strtolower(trim((string)($_POST['gender'] ?? $_POST['sex'] ?? '')));
...
try {
    ...
    $hasGender        = in_array('gender', $userCols, true);
...
<head>
  ...
  <link rel="stylesheet" href="<?= htmlspecialchars($base) ?>/app/views/register/assests/css/styles.css?v=<?= time() ?>" />
</head>
<body>
...
//css of gender dropdown in register page
