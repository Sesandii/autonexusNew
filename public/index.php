...
$router->get('/receptionist/billing/printInvoice', [app\controllers\Receptionist\BillingController::class, 'printInvoice']);
$router->get('/receptionist/billing/downloadInvoice/{id}',[app\controllers\Receptionist\BillingController::class, 'printInvoice']);
...
if ($scriptBase && strpos($incomingPath, $scriptBase) === 0) {
    ...
    if ($incomingPath === '' || $incomingPath === false)
        $incomingPath = '/';
}
