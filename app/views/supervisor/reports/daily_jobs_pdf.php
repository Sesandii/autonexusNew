...
<head>
    <style>
        ...
        .chart-box { width: 31%; display: inline-block; text-align: center; margin-top: 20px; vertical-align: top; }
...
<body>
    ...
    <div style="width: 100%;">
        <div class="chart-box">
            ...
            <img src="<?= $chartStatus ?>" class="chart-img">
        </div>
        <div class="chart-box">
            <strong>Hourly Load</strong><br>
            <img src="<?= $chartHourly ?>" class="chart-img">
        </div>
        <div class="chart-box">
            <strong>7-Day Trend</strong><br>
            <img src="<?= $chartTrend ?>" class="chart-img">
        </div>
    </div>
</body>
</html>