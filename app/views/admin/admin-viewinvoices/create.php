...
$B = rtrim(BASE_URL, '/');
$current = 'invoices';
$completedCount = count($workOrders ?? []);
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <link rel="stylesheet" href="<?= $B ?>/public/assets/css/admin/invoices/create.css?v=3">
...
<body>
  ...
  <main class="main-content invoice-create-main">
    <section class="dash-wrap invoice-create-page">
      <header class="topbar">
        <div>
          <h1 class="page-title">Create Invoice</h1>
          <p class="subtitle">Generate invoices from completed work orders.</p>
        </div>
        <div class="topbar-actions">
          <a href="<?= $B ?>/admin/admin-viewinvoices" class="btn-secondary">
      ...
      <div class="invoice-summary-grid">
        <article class="summary-card">
          <div class="summary-head"><span class="summary-icon"><i class="fa-solid fa-receipt"></i></span></div>
          <p>Eligible Work Orders</p>
      ...
      <div class="invoice-layout">
        <section class="panel invoice-list-panel">
          <div class="panel-head">
            <div>
              <h2><i class="fa-solid fa-list-check"></i> Eligible Work Orders</h2>
              ...
              <tbody>
                <?php if (!empty($workOrders)): ?>
                  <?php foreach ($workOrders as $wo): ?>
                    ...
                    ?>
                    <tr data-customer="<?= htmlspecialchars(strtolower($cust)) ?>"
                      ...
                      <td class="td-actions">
                        <button class="chip-btn chip-btn--dark" type="button"
        ...
        <section class="panel invoice-form-panel hidden" id="invoiceFormWrap">
          <form method="post" action="<?= $B ?>/admin/admin-viewinvoices/store" id="invoiceForm"
            ...
            <div class="form-actions">
              <button class="btn-primary btn-generate-invoice" type="submit">
