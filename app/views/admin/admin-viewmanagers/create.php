...
<body>
  ...
  <main class="main-content">
    ...
    <form class="form" method="post" action="<?= htmlspecialchars($base . '/service-managers', ENT_QUOTES, 'UTF-8') ?>">
      <div class="row">
        <div>
        ...
        <div>
          ...
          <input class="input" name="manager_code" value="<?= htmlspecialchars($old['manager_code'] ?? '') ?>" required>
        </div>
        <div>
