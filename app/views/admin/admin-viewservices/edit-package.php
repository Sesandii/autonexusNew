...
<head>
    ...
    <style>
        ...
        .pkg-row {
            display: grid;
            grid-template-columns: 1.6fr 100px auto;
            gap: 10px;
            align-items: center;
            margin-bottom: 10px
        }
...
<body>
    ...
    <main class="main-content">
        ...
        <form method="post" action="<?= $base ?>/admin/packages/<?= (int) $row['service_id'] ?>">
            ...
            <div class="card">
                <h2 style="margin-top:0;">Package Items</h2>
            ...
            <div class="card">
                ...
                <div id="branchPicker" class="branch-box"
                    style="display:<?= ($applyAll ?? false) ? 'none' : 'block' ?>;">
