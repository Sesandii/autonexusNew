    ...
    <section class="management">
      <header class="management-header">
        <div>
          ...
          <p class="management-subtitle">Monitor and manage service branches.</p>
        </div>

        <div class="tools">
          <form method="get" action="<?= e($base . '/admin/branches') ?>" class="tools">
            <input type="text" class="search-input" name="q" placeholder="Search by code, name, city, manager..."
              value="<?= e($q) ?>" />
