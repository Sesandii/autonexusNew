...
<head>
  ...
  <link rel="stylesheet" href="<?= $base ?>/public/assets/css/manager/viewHistory.css">
...
<body>
  ...
  <div class="main">
    <div class="service-history">
      ...
      <div class="history-item">
        <div class="service-used">
          <p><b>Oil Change</b> <br><span><small>2024-01-15</small></span></p>
        </div>
        <div class="history-content">
          <div class="label">Technician:</div>
          <div class="value">Bill Hawkins</div>
  ...
  <script src="<?= $base ?>/public/assets/js/manager/viewHistory.js"></script>
</body>
</html>
